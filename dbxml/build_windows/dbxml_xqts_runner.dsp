...
PostBuild_Cmds=installProj.bat dbxml_xqts_runner prog ..\build_windows\Release release
...
# ADD LINK32 /libpath:..\build_windows\Debug /libpath:Debug libdbxml25d.lib libdb48d.lib xerces-c_3d.lib xqilla22d.lib /libpath:../../xqilla/build/windows/vc6/Debug /libpath:../../db-4.8.26/build_windows/Debug /nologo /subsystem:console /pdb:./Debug/dbxml_xqts_runner.pdb /debug /machine:I386 /nodefaultlib:"libcmtd" /fixed:no /libpath:../../xerces-c-src/lib /libpath:../../xerces-c-src/build/win32/vc6/debug

# Begin Special Build Tool
PostBuild_Desc=Install files
PostBuild_Cmds=installProj.bat dbxml_xqts_runner prog ..\build_windows\Debug debug
# End Special Build Tool
!ENDIF 
